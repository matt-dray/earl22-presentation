...
::: {.notes}
* The package helps bring automation, consistency and reproducibility; it does the hard work for you.
...
::: {.notes}
* A demo: let's convert the published eggs spreadsheet with {a11ytables}.
* From installing the package to a vanilla spreadsheet output.
:::
...
::: {.notes}
* The package hasn't reached a v1 yet; there's more to do.
* So it's GitHub only for now.
...
::: {.column width="40%"}
Help for generating best-practice spreadsheets
...
::: {.column width="25%"}
![](images/hex_a11ytables-logo.png){width="85%" height="85%" alt="Hex logo for the a11ytables R package. Letters of the word are split into separatae cells of a grid."}
:::
