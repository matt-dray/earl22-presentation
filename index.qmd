...
## tl;dr {.center background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
## Ahoy {.center background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
::: {.clippy-speech .absolute top='150%' left='150%' data-id='speech' }
It looks like you're trying to improve a spreadsheet.
:::

![](images/not-clippy.png){.absolute top='150%' left='150%' width='100'}

## {auto-animate=true auto-animate-easing='ease-in-out' background-image='images/website_eggs.png'}

::: {.clippy-speech .absolute top='15%' left='45%' data-id='speech' }
It looks like you're trying to improve a spreadsheet.
:::
...
* Luckily, there is some codified and exhaustive guidance on the preferred outcomes.
:::
...
* [Reproducible Analytical Pipelines (RAP)](https://analysisfunction.civilservice.gov.uk/support/reproducible-analytical-pipelines/) is a grassroots movement that's been bubbling around UK government for a few years and there's now [a formal strategy for adoption](https://analysisfunction.civilservice.gov.uk/policy-store/reproducible-analytical-pipelines-strategy/).
...
# Building a tool {background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
## Requirements {.center background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
# How {background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
## Write to xlsx {auto-animate='true' background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
# Output {background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}

## {auto-animate=true auto-animate-easing='ease-in-out' background-image='images/spreadsheet_new-eggs-cover.png'}

![](images/not-clippy.png){.absolute top='40%' left='35%' width='100'}
...
![](images/not-clippy.png){.absolute top='2%' left='25%' width='100'}
...
![](images/not-clippy.png){.absolute top='20%' left='35%' width='100'}
...
![](images/not-clippy.png){.absolute top='3%' left='35%' width='100'}
...
![](images/not-clippy.png){.absolute  top='5%' left='35%' top=20 left=400 width='100'}
...
![](images/not-clippy.png){.absolute  top='30%' left='15%' width='100'}
...
## Current issues {.center background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}

* Writes to xlsx, not ods
...
## Future {.center background-image='images/bg_cells.png' background-size='250px' background-repeat='repeat'}
...
* See [Duncan Garmonsway](https://nacnudus.github.io/duncangarmonsway/)'s [{tidyxl}](https://nacnudus.github.io/tidyxl/index.html) and [{unpivotr}](https://nacnudus.github.io/unpivotr/) R packages for help.
