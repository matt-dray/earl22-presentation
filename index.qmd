...
::: {.notes}
* The main take-away is that there's an R package called {a11ytables} you can use and contribute to.
* It helps automate and make reproducible the steps needed to comply with best-practice guidance about spreadsheets.
* The talk is about the package, of course.
* But it's also about inclusivity, taking the initiative and making things better.
:::
