...
::: {.notes}
* The package brings automation, consistency and reproducibility; it does the hard work for you.
...
![](images/not-clippy.png){.absolute top="120%" left="120%" width="100"  alt="An unofficial version of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="30%" left="65%" width="100" alt="An unofficial version of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="3%" left="55%" width="100" alt="An unofficial version of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="75%" left="45%" width="100" alt="An unofficial version of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="25%" left="27%" width="100" alt="An unofficial version of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
4. Known: have been sharing this in cross-government fora, Twitter, presentation champions meeting, Scottish government. And here I am.
:::
