...
## {auto-animate="true" auto-animate-easing="ease-in-out" background-image="images/website_eggs.png" alt="Screenshot of the GOV.UK webpage containing data released as part of the latest UK egg statistics, which has the National Statistics badge."}
...
![](images/not-clippy.png){.absolute top="120%" left="120%" width="100"  alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="30%" left="65%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="3%" left="55%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="75%" left="45%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
![](images/not-clippy.png){.absolute top="25%" left="27%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
## {background-image="images/website_spreadsheet-guidance-af.png" alt="Screenshot of a page of the UK government's Analysis Function website, which contains guidance called 'releasing statistics in spreadsheets'."}
...
![](images/not-clippy-inverse.png){.absolute top="70%" left="95%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes."}
...
## {background-image="images/website_rap-strategy.png" alt="Screenshot of the UK government's Analysis Function website, on a page that contains the Reproducible Analytrical Pipelines (RAP) strategy."}
...
## {background-image="images/website_a11ytables-docs.png" alt="Screesnhot of the documentation website for the R package called 'a11ytables', which is open on the README page."}
...
## {background-image="images/website_gptables-docs.png" alt="Screesnhot of the documentation website for the Python package called 'gptables', which is open on the README page."}
...
![](images/not-clippy-heart.png){.absolute top="40%" left="35%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
![](images/not-clippy-heart.png){.absolute top="2%" left="25%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
![](images/not-clippy-heart.png){.absolute top="20%" left="35%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
![](images/not-clippy-heart.png){.absolute top="3%" left="35%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
![](images/not-clippy-heart.png){.absolute top="5%" left="35%" width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
![](images/not-clippy-heart.png){.absolute  top="30%" left='15%' width="100" alt="An unofficial of the The Microsoft Office mascot Clippy, a paperclip with eyes, with a red heart above his head."}
...
1. Could you create common tools to remove friction?
...
* Analysis Function accessibility: Hannah Thomas
